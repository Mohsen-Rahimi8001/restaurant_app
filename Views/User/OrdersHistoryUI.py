...
def info(window : QtWidgets.QMainWindow, ui : "Ui_MainWindow", order : Order):

        Transfer.Add("order_info_id", order.id)
        Routing.Redirect(window, "orderInfo")
...
class Ui_MainWindow(object):
    ...
    def addDeliveredOrder(self, window : QtWidgets.QMainWindow, order : Order):
        """add delivered order"""
        ...
        self.orderInfoBtn_2 = QtWidgets.QPushButton(self.deliveredOrderWidget_2)
        self.orderInfoBtn_2.setGeometry(QtCore.QRect(20, 80, 101, 21))
        self.orderInfoBtn_2.setStyleSheet("border-width:0px;\n"
                                          "border-color: rgb(5, 85, 82);\n"
                                          "border-radius:0px;\n"
                                          "background-color: rgb(245, 247, 250);\n"
                                          "padding-left:0px;\n"
                                          "")
        self.orderInfoBtn_2.setObjectName("orderInfoBtn_2")
    ...
    def addOnGoingOrder(self, window : QtWidgets.QMainWindow, order : Order):

            self.onGoingOrderWidget = QtWidgets.QWidget(self.scrollAreaWidgetContents_3)
            self.onGoingOrderWidget.setMinimumSize(QtCore.QSize(0, 120))
            self.onGoingOrderWidget.setMaximumSize(QtCore.QSize(16777215, 120))
            self.onGoingOrderWidget.setStyleSheet("background-color: rgb(255, 255, 255);\n"
                                                  "border-style : solid;\n"
                                                  "border-bottom-width : 2px;\n"
                                                  "border-color: rgb(51, 165, 24);")
            self.onGoingOrderWidget.setObjectName("onGoingOrderWidget")
            self.paymentLabel = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.refNumValue = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.paymentValue = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.accNumLabel = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.accNumValue = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.refNumLabel = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.divider1 = QtWidgets.QWidget(self.onGoingOrderWidget)
            ...
            self.divider2 = QtWidgets.QWidget(self.onGoingOrderWidget)
            ...
            self.orderInfoBtn = QtWidgets.QPushButton(self.onGoingOrderWidget)
            self.orderInfoBtn.setGeometry(QtCore.QRect(20, 80, 101, 21))
            self.orderInfoBtn.setStyleSheet("border-width:0px;\n"
                                            "border-color: rgb(5, 85, 82);\n"
                                            "border-radius:0px;\n"
                                            "background-color: rgb(245, 247, 250);\n"
                                            "padding-left:0px;\n"
                                            "")
            self.orderInfoBtn.setObjectName("orderInfoBtn")
            self.orderDateValue = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.deliverDateLabel = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.priceLabel = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.priceValue = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.orderDateLabel = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.deliverDateValue = QtWidgets.QLabel(self.onGoingOrderWidget)
            ...
            self.cancelBtn = QtWidgets.QPushButton(self.onGoingOrderWidget)
            ...
            self.verticalLayout.addWidget(self.onGoingOrderWidget)

    def addProcessingOrder(self, window : QtWidgets.QMainWindow, order : Order):
        """add not confirmed order"""
        self.deliveredOrderWidget_2 = QtWidgets.QWidget(self.scrollAreaWidgetContents_3)
        self.deliveredOrderWidget_2.setMinimumSize(QtCore.QSize(0, 120))
        self.deliveredOrderWidget_2.setMaximumSize(QtCore.QSize(16777215, 120))
        self.deliveredOrderWidget_2.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        ...
        payment = "online" if order.payment_method == 0 else "payment on the spot"
        ...
        self.orderInfoBtn.setText("More Info")
...
"font-size: 10pt;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.refNumValue_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\"></span></p></body></html>")
        self.paymentValue_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\"></span></p></body></html>")
        self.accNumLabel_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\">Acc Number</span></p></body></html>")
        self.accNumValue_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\"></span></p></body></html>")
        self.refNumLabel_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\">Ref Number</span></p></body></html>")
        self.orderInfoBtn_2.setText("More Info")
        self.orderDateValue_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\"></span></p></body></html>")
        ...
        self.priceValue_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\"></span></p></body></html>")
        self.orderDateLabel_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\">Order Date</span></p></body></html>")
        self.deliverDateValue_2.setText("<html><head/><body><p align=\"center\"><span style=\" color:#055552;\"></span></p></body></html>")
        self.deliveredLabel.setText("<html><head/><body><p align=\"center\">Delivered</p></body></html>")
